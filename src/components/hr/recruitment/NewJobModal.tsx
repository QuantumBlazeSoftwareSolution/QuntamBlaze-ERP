      ...
      <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
        ...
        >
              ...
              <div className="grid grid-cols-3 gap-6">
                <div className="space-y-1.5 relative">
                  ...
                  <input
                    type="number"
                    placeholder="0"
                    className="w-full h-11 pl-9 pr-4 rounded-xl border border-[#E2E8F0] text-sm"
                  />
                </div>
                <div className="space-y-1.5 relative">
                  <label className="text-[11px] font-bold text-[#94A3B8] uppercase tracking-widest px-1">
          ...
          <div className="p-6 border-t border-[#F1F5F9] bg-[#F8FAFC] flex justify-end gap-3">
            ...
            <button className="px-8 py-2.5 rounded-xl text-sm font-bold bg-[#10B981] text-white shadow-lg shadow-[#10B981]/20 hover:scale-[1.02] active:scale-[0.98] transition-all">
              Post Opening
            </button>
          </div>
        </motion.div>
