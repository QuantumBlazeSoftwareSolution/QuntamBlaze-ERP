...
import { Settings, Clock, ShieldCheck, Zap, Save, Bell, MinusCircle } from "lucide-react";
      ...
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-[10px] text-[#94A3B8] font-bold uppercase tracking-widest mt-1">
            Global Configuration for Workforce Logs
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
        ...
        <div className="space-y-8">
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-[10px] text-[#94A3B8] font-medium">
                    Hours before OT multiplier applies
                  </p>
                </div>
          ...
          <div className="p-5 rounded-2xl bg-amber-50 border border-amber-100 flex gap-4">
            ...
            <div>
              <h5 className="text-[11px] font-black text-amber-900 uppercase tracking-widest mb-1">
                Compliance Warning
              </h5>
              <p className="text-[10px] text-amber-800 leading-relaxed font-medium">
                Changes to shift rules will be audited and logged under SHF-CONF-2024. All affected
                employees will be notified of the update via the portal.
              </p>
            </div>
          </div>
        </div>
