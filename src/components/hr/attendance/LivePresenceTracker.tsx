...
const MOCK_PRESENCE = [
  { id: 'EMP-ENG-26-001', name: 'Alex Mercer', role: 'Senior Engineer', time: '08:45 AM', location: 'Remote', device: 'Desktop' },
  { id: 'EMP-HR-26-004', name: 'Sarah Jenkins', role: 'HR Manager', time: '09:02 AM', location: 'Office', device: 'Mobile' },
  { id: 'EMP-ENG-26-042', name: 'James Wilson', role: 'Software Dev', time: '08:58 AM', location: 'Office', device: 'Desktop' },
  { id: 'EMP-FIN-26-015', name: 'Elena Vance', role: 'Finance Analyst', time: '09:15 AM', location: 'Remote', device: 'Laptop' },
];
    ...
    <div className="bg-white border border-[#E2E8F0] rounded-3xl p-6 shadow-sm h-full flex flex-col">
      <div className="flex items-center justify-between mb-6">
        <div>
           ...
           <p className="text-[10px] text-[#94A3B8] font-bold uppercase tracking-widest mt-1">Currently On Clock</p>
        </div>
        ...
        {MOCK_PRESENCE.map((person) => (
          ...
          >
             <div className="flex items-center gap-3">
                ...
                <div>
                   <p className="text-xs font-black text-[#0F172A] group-hover:text-[#10B981] transition-colors">{person.name}</p>
             ...
             <div className="text-right flex items-center gap-6">
                <div className="hidden md:block">
                   ...
                   <div className="flex items-center gap-1.5 justify-end mt-0.5">
                      ...
                      <span className="text-[9px] font-bold text-[#94A3B8] uppercase">{person.location}</span>
                   </div>
                </div>
