...
const MOCK_TASKS = [
  {
    id: 1,
    title: "Provision Workstation (M3 Max Laptop)",
    category: "IT",
    isCompleted: false,
    dueDate: "May 14",
    priority: "High",
  ...
  {
    id: 3,
    title: "Setup GitHub & Slack Access",
    category: "IT",
    isCompleted: false,
    dueDate: "May 15",
    priority: "High",
  ...
  {
    id: 4,
    title: "Introductory Team Coffee Chat",
    category: "Team",
    isCompleted: false,
    dueDate: "May 16",
    priority: "Medium",
  ...
  {
    id: 5,
    title: "Direct Deposit Form Submission",
    category: "Finance",
    isCompleted: false,
    dueDate: "May 15",
    priority: "High",
      ...
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-[10px] text-[#94A3B8] font-bold uppercase tracking-widest mt-1">
            Onboarding Plan: ONB-EMP-ENG-26-001-01
          </p>
        </div>
        ...
        {CATEGORIES.map((cat) => {
          ...
          return (
            <div key={cat.id} className="space-y-3">
              <div
                className={cn(
                  "flex items-center gap-2 px-3 py-1.5 rounded-lg border border-transparent w-fit",
                  cat.bg
                )}
              >
                ...
                {catTasks.map((task) => (
                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      >
                        {task.isCompleted ? (
                          <CheckSquare className="w-5 h-5 fill-current text-white bg-[#10B981] rounded" />
                        ) : (
