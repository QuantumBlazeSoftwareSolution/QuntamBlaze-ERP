          ...
          <div key={stage.id} className="flex flex-col min-w-[300px] max-w-[300px] h-full">
            ...
            <div className="flex-1 bg-white/50 border border-[#E2E8F0] rounded-2xl p-3 space-y-4 overflow-y-auto scrollbar-hide">
              {stageHires.map((hire) => (
                <div
                  key={hire.id}
                  className="bg-white border border-[#E2E8F0] rounded-xl p-4 shadow-sm hover:shadow-md transition-all group"
                >
                  ...
                  <h4 className="text-[#0F172A] text-sm font-bold mb-1 group-hover:text-[#10B981] transition-colors">
                    {hire.name}
                  </h4>
                  <p className="text-[10px] text-[#94A3B8] font-medium mb-4">
                    {hire.role} • {hire.dept}
                  </p>
                    ...
                    <div className="p-2.5 rounded-lg bg-red-50 border border-red-100 mb-4">
                      ...
                      <div className="flex flex-wrap gap-1">
                        {hire.missingItems.map((item) => (
                          <span
                            key={item}
                            className="text-[9px] font-bold text-red-700 bg-white px-1.5 py-0.5 rounded border border-red-200"
                          >
                            {item}
                          </span>
                        ))}
                  ...
                  <div className="flex items-center justify-between pt-3 border-t border-[#F1F5F9]">
                    ...
                    <div className="flex -space-x-1">
                      <div
                        className="w-6 h-6 rounded-full bg-blue-50 border border-white flex items-center justify-center"
                        title="IT Readiness"
                      >
                        <Laptop className="w-3 h-3 text-blue-500" />
                      </div>
                      <div
                        className="w-6 h-6 rounded-full bg-emerald-50 border border-white flex items-center justify-center"
                        title="HR Documents"
                      >
