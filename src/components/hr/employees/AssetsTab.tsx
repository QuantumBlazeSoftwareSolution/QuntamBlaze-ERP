        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          {PHYSICAL_ASSETS.map((asset) => {
            ...
            return (
              <div
                key={asset.id}
                className="bg-white border border-[#F1F5F9] rounded-2xl p-6 hover:shadow-md transition-all group"
              >
                ...
                <h4 className="text-sm font-black text-[#0F172A] mb-1 line-clamp-1">
                  {asset.name}
                </h4>
                <p className="text-[10px] text-[#94A3B8] font-bold uppercase tracking-widest mb-4">
                  {asset.id}
                </p>
