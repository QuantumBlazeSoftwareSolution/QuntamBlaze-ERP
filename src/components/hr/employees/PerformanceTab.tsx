      ...
      <div className="space-y-8">
        ...
        <div className="bg-[#0F172A] rounded-3xl p-8 text-white relative overflow-hidden">
          ...
          <p className="text-sm text-slate-300 leading-relaxed mb-6">
            {employee.name} has consistently exceeded expectations in technical delivery. Currently
            transitioning into a Lead Engineer role with a focus on cross-team architecture and
            mentorship.
          </p>
