...
import { MoreVertical, Mail, Phone, MapPin, ChevronRight, ShieldCheck, Star } from "lucide-react";
      ...
      {employees.map((employee, idx) => (
        ...
        >
          ...
          <div className="relative z-10">
            ...
            <div className="mb-6">
              <h3 className="text-[#0F172A] text-lg font-black tracking-tight group-hover:text-[#10B981] transition-colors">
                {employee.name}
              </h3>
...
function ContactItem({ icon: Icon, value }: { icon: any; value: string }) {
  return (
    <div className="flex items-center gap-2 text-[#94A3B8] group/item cursor-pointer">
      ...
      <span className="text-[11px] font-medium group-hover/item:text-[#475569] transition-colors truncate">
        {value}
      </span>
    </div>
  );
