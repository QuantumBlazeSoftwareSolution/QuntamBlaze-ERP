  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
         <MetricCard label="Tenure" value="1y 4m" subtext={`Joined ${employee.joinDate}`} icon={Clock} color="text-blue-500" bg="bg-blue-50" />
         <MetricCard label="Reports To" value={employee.reportingTo?.name || "Direct Board"} subtext="Line Manager" icon={Users} color="text-violet-500" bg="bg-violet-50" />
         <MetricCard label="Designation" value={employee.role} subtext={employee.department} icon={Target} color="text-[#10B981]" bg="bg-emerald-50" />
         <MetricCard label="Work Mode" value="Remote" subtext="Global Ops" icon={MapPin} color="text-amber-500" bg="bg-amber-50" />
      </div>
         ...
         <div className="lg:col-span-2 space-y-8">
            <section>
              <div className="flex items-center justify-between mb-6">
                 ...
                 <button className="text-[10px] font-bold text-[#3B82F6] hover:underline">Add Milestone</button>
              </div>
            ...
            <section>
              ...
              <div className="bg-white border border-[#F1F5F9] rounded-2xl p-6 space-y-6">
                 <div className="space-y-1">
                    <p className="text-[10px] font-black text-[#94A3B8] uppercase tracking-widest">Contract Type</p>
                    <p className="text-sm font-bold text-[#475569]">Permanent / Full-Time</p>
                 </div>
                 <div className="space-y-1">
                    <p className="text-[10px] font-black text-[#94A3B8] uppercase tracking-widest">Work Authorization</p>
                 ...
                 <div className="p-4 rounded-xl bg-violet-50 border border-violet-100">
                    <div className="flex justify-between items-start mb-2">
                       <p className="text-[10px] font-black text-violet-700 uppercase tracking-widest">Probation Status</p>
                       <span className="text-[9px] font-black text-white bg-violet-500 px-1.5 py-0.5 rounded uppercase">Passed</span>
                    </div>
                    <p className="text-xs font-medium text-violet-900 leading-relaxed">
                       Successfully cleared probation on April 15, 2023. Recommended for permanent retention.
                    </p>
                 </div>
              </div>
            </section>
    ...
    <div className="relative pl-12">
       ...
       <div>
          <div className="flex items-center gap-3 mb-1">
             ...
             <span className="text-[10px] font-bold text-[#94A3B8] bg-[#F1F5F9] px-2 py-0.5 rounded">{date}</span>
          </div>
