...
export function EmployeeProfileHeader({ employee }: EmployeeProfileHeaderProps) {
  const healthColor = employee.profileHealth && employee.profileHealth >= 90 
        ...
        <div className="flex gap-6 flex-1">
          ...
          <div className="flex-1">
             <div className="flex flex-col md:flex-row md:items-center gap-3 mb-2">
                <h1 className="text-[#0F172A] text-2xl lg:text-3xl font-black tracking-tight">{employee.name}</h1>
        ...
        <div className="flex flex-col justify-between items-end gap-6">
           ...
           <div className="w-full lg:w-48 p-4 rounded-2xl border border-[#F1F5F9] bg-[#F8FAFC]">
              <div className="flex items-center justify-between mb-2">
                 <span className="text-[10px] font-bold text-[#94A3B8] uppercase tracking-widest">Profile Health</span>
                 <span className={cn("text-[10px] font-black px-1.5 py-0.5 rounded border", healthColor)}>
              ...
              <div className="h-2 bg-[#E2E8F0] rounded-full overflow-hidden">
                 <motion.div 
                   ...
                   className={cn(
                     ...
                     employee.profileHealth && employee.profileHealth >= 90 ? "bg-[#10B981]" : "bg-amber-500"
                   )}
                 />
              </div>
           </div>
