    ...
    <div className="bg-white border border-[#E2E8F0] rounded-3xl overflow-hidden shadow-sm">
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <Link href={`/dashboard/hr/employees/${employee.id}`}>
                        <p className="text-sm font-black text-[#0F172A] group-hover:text-[#10B981] transition-colors hover:underline cursor-pointer">
                          {employee.name}
                        </p>
                      </Link>
      ...
      <div className="bg-[#F8FAFC] border-t border-[#E2E8F0] px-6 py-4 flex items-center justify-between">
        ...
        <div className="flex gap-2">
          <button className="px-3 py-1 rounded-lg border border-[#E2E8F0] bg-white text-[10px] font-black text-[#64748B] hover:bg-[#F1F5F9] transition-all">
            PREVIOUS
          </button>
          <button className="px-3 py-1 rounded-lg border border-[#E2E8F0] bg-white text-[10px] font-black text-[#64748B] hover:bg-[#F1F5F9] transition-all">
            NEXT
