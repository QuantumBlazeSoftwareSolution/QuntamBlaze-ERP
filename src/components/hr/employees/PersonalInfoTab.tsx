          ...
          <div className="bg-white border border-[#F1F5F9] rounded-2xl p-6 space-y-6">
             <div className="flex items-center gap-4">
                ...
                <div>
                   ...
                   <p className="text-[10px] text-[#94A3B8] font-bold uppercase tracking-wider">Spouse</p>
                </div>
             </div>
             <div className="grid grid-cols-2 gap-6">
        ...
        <section>
          ...
          <div className="bg-white border border-[#F1F5F9] rounded-2xl p-6 space-y-6">
             ...
             <div className="p-4 rounded-xl bg-amber-50 border border-amber-100">
                <p className="text-[10px] font-black text-amber-700 uppercase tracking-widest mb-1">Insurance Policy</p>
                <p className="text-sm font-bold text-amber-900 tracking-tight">QM-LTD-2024-0512-MC</p>
                <p className="text-[10px] text-amber-600 font-medium mt-1">Provider: Allianz Life Insurance</p>
             </div>
          </div>
        </section>
      </div>
