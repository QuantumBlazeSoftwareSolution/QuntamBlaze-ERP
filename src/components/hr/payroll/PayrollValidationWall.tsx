    ...
    <div className="bg-[#0F172A] rounded-3xl p-8 text-white h-full flex flex-col shadow-xl">
      <div className="flex items-center justify-between mb-10">
        <div>
           ...
           <p className="text-[10px] text-slate-400 font-bold uppercase tracking-widest mt-1">Consistency & Data Integrity Check</p>
        </div>
      </div>
      ...
      <div className="mt-10 p-6 rounded-2xl bg-white/5 border border-white/10 flex items-center gap-4">
         ...
         <div className="flex-1">
            <h5 className="text-[10px] font-black uppercase tracking-widest text-slate-300">Bank Transfer Ready</h5>
...
function ValidationItem({ status, title, description }: { status: 'success' | 'warning' | 'neutral', title: string, description: string }) {
  return (
    <div className="flex gap-4 p-4 rounded-2xl bg-white/5 border border-white/5 group hover:border-white/10 transition-all">
       <div className={cn(
         ...
         status === 'success' ? "bg-[#10B981]/20 text-[#10B981]" :
