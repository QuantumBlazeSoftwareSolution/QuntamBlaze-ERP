    ...
    <div className="bg-[#0F172A] rounded-3xl p-8 text-white h-full flex flex-col shadow-xl">
      <div className="flex items-center justify-between mb-10">
        <div>
           ...
           <p className="text-[10px] text-slate-400 font-bold uppercase tracking-widest mt-1">Fiscal Year 2024 Summary</p>
        </div>
      </div>

      <div className="flex-1 space-y-6">
         <TaxItem label="EPF Employee Share" value="84,200.00" sub="8% Basic" color="text-blue-400" />
         <TaxItem label="EPF Employer Share" value="126,300.00" sub="12% Basic" color="text-violet-400" />
         <TaxItem label="ETF Contribution" value="31,575.00" sub="3% Basic" color="text-emerald-400" />
         <TaxItem label="PAYE Tax Deducted" value="58,000.00" sub="Cumulative" color="text-amber-400" />
      </div>
...
function TaxItem({ label, value, sub, color }: { label: string, value: string, sub: string, color: string }) {
  return (
