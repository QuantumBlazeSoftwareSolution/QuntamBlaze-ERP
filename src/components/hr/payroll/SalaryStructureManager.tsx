...
const MOCK_STRUCTURES = [
  { id: 'PAY-STR-ENG-01', name: 'Engineering Lead Structure', grade: 'Lead (G4)', base: '250,000', net: '315,500', currency: 'LKR', status: 'Active' },
  { id: 'PAY-STR-ENG-02', name: 'Senior Engineer Structure', grade: 'Senior (G3)', base: '180,000', net: '224,200', currency: 'LKR', status: 'Active' },
  { id: 'PAY-STR-HR-01', name: 'Executive HR Structure', grade: 'Executive (G2)', base: '95,000', net: '112,000', currency: 'LKR', status: 'Active' },
];
    ...
    <div className="bg-white border border-[#E2E8F0] rounded-3xl p-8 shadow-sm flex flex-col h-full">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-10">
        <div>
           ...
           <p className="text-[10px] text-[#94A3B8] font-bold uppercase tracking-widest mt-1">Grade-based Compensation Templates</p>
        </div>
              ...
              >
                 <div className="flex items-start justify-between mb-6">
                    <div>
                       ...
                       <p className="text-[10px] font-bold text-blue-600 uppercase tracking-widest mt-1">{structure.grade}</p>
                    </div>
                 ...
                 <div className="grid grid-cols-2 gap-4 mb-6">
                    <div className="p-3 rounded-2xl bg-white border border-[#F1F5F9]">
                       <p className="text-[9px] font-black text-[#94A3B8] uppercase tracking-widest mb-1">Base Salary</p>
                       <p className="text-sm font-black text-[#0F172A]">{structure.base} <span className="text-[10px] text-[#94A3B8]">{structure.currency}</span></p>
                    </div>
                    <div className="p-3 rounded-2xl bg-white border border-[#F1F5F9]">
                       <p className="text-[9px] font-black text-[#94A3B8] uppercase tracking-widest mb-1">Estimated Net</p>
                       <p className="text-sm font-black text-[#10B981]">{structure.net} <span className="text-[10px] text-[#94A3B8]">{structure.currency}</span></p>
                    </div>
                 </div>
      ...
      <div className="mt-10 p-5 rounded-2xl bg-blue-50 border border-blue-100 flex items-center gap-4">
         ...
         <p className="text-[11px] text-blue-800 font-medium leading-relaxed flex-1">
            Structures are currently using the <span className="font-bold">STAT-SL-24</span> statutory rule set. Any changes to EPF/ETF will reflect in next month's payroll preview.
         </p>
      </div>
    </div>
  );
