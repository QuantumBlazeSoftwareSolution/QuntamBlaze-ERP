      ...
      <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
        ...
        >
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <div className="flex items-center gap-2 mt-0.5">
                  ...
                  <span className="text-[#94A3B8] text-[10px] font-medium uppercase tracking-wider">
                    New Session
                  </span>
                </div>
              </div>
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-[10px] text-amber-700 mt-1 leading-relaxed">
                      Alex Mercer has another session scheduled (INT-26-047) at this time. Please
                      select another slot or interviewer.
                    </p>
                  </div>
                </motion.div>
              )}
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative group">
                ...
                <div className="absolute right-3 top-1/2 -translate-y-1/2 flex items-center gap-2">
                  <span className="text-[10px] font-bold text-[#3B82F6] bg-blue-50 px-2 py-1 rounded cursor-pointer hover:bg-blue-100 transition-all">
                    Auto-generate
                  </span>
                </div>
              </div>
          ...
          <div className="p-6 border-t border-[#F1F5F9] bg-[#F8FAFC] flex justify-end gap-3">
            ...
            <button className="px-8 py-2.5 rounded-xl text-sm font-bold bg-[#10B981] text-white shadow-lg shadow-[#10B981]/20 hover:scale-[1.02] active:scale-[0.98] transition-all flex items-center gap-2">
