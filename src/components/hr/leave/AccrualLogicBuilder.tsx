...
import { Zap, ArrowRight, Plus, Minus, Settings, Calendar, Lock, Layers } from "lucide-react";
      ...
      <div className="flex items-center justify-between mb-10">
        <div>
          ...
          <p className="text-[10px] text-slate-400 font-bold uppercase tracking-widest mt-1">
            Automated Entitlement Sequencing
          </p>
        </div>
      ...
      <div className="flex-1 space-y-8">
        ...
        <div className="p-6 rounded-2xl bg-amber-500/10 border border-amber-500/20 flex gap-4">
          ...
          <p className="text-[10px] text-amber-200/70 leading-relaxed font-medium">
            Logic changes will be effective from the next accrual cycle (JUN-24). Existing balances
            will not be recalculated unless "Force Re-Sync" is triggered.
          </p>
        </div>
      </div>
