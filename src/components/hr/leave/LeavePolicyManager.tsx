...
const MOCK_POLICIES = [
  { id: 'POL-ANN-24', type: 'Annual Leave', entitlement: '21 Days', carryForward: '5 Days', appliesTo: 'All Staff', status: 'Active' },
  { id: 'POL-SCK-24', type: 'Sick Leave', entitlement: '14 Days', carryForward: 'None', appliesTo: 'All Staff', status: 'Active' },
  { id: 'POL-CSL-24', type: 'Casual Leave', entitlement: '7 Days', carryForward: 'None', appliesTo: 'Conf. Only', status: 'Active' },
  { id: 'POL-MAT-24', type: 'Maternity', entitlement: '90 Days', carryForward: 'None', appliesTo: 'Female', status: 'Special' },
];
    ...
    <div className="bg-white border border-[#E2E8F0] rounded-3xl p-8 shadow-sm h-full flex flex-col">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-10">
        <div>
           ...
           <p className="text-[10px] text-[#94A3B8] font-bold uppercase tracking-widest mt-1">Configure Entitlements & Accruals</p>
        </div>
              ...
              >
                 <div className="flex items-start justify-between mb-6">
                    ...
                    <div className={cn(
                      ...
                      policy.status === 'Active' ? "bg-emerald-50 text-emerald-600 border-emerald-100" : "bg-blue-50 text-blue-600 border-blue-100"
                    )}>
                       {policy.status}
                    </div>
                 </div>
                 ...
                 <div className="grid grid-cols-2 gap-4 mb-6">
                    <div className="p-3 rounded-2xl bg-white border border-[#F1F5F9]">
                       <p className="text-[9px] font-black text-[#94A3B8] uppercase tracking-widest mb-1">Entitlement</p>
                       <p className="text-sm font-black text-[#0F172A]">{policy.entitlement}</p>
                    </div>
                    <div className="p-3 rounded-2xl bg-white border border-[#F1F5F9]">
                       <p className="text-[9px] font-black text-[#94A3B8] uppercase tracking-widest mb-1">Carry-Forward</p>
                 ...
                 <div className="flex items-center justify-between pt-4 border-t border-white">
                    <div className="flex items-center gap-2">
                       ...
                       <span className="text-[10px] font-bold text-[#64748B]">Applies to: <span className="text-[#0F172A]">{policy.appliesTo}</span></span>
                    </div>
      ...
      <div className="mt-10 p-6 rounded-3xl bg-blue-50 border border-blue-100 flex items-center gap-6">
         ...
         <div className="flex-1">
            <h5 className="text-sm font-black text-blue-900 uppercase tracking-widest">Proration Engine Active</h5>
            <p className="text-[11px] text-blue-700 leading-relaxed font-medium">
               New policies will automatically be prorated based on joining date (EMP-JOIN-YYYY) unless explicitly disabled in global settings.
            </p>
         </div>
