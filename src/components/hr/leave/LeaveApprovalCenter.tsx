...
const MOCK_REQUESTS = [
  { id: 'LEV-014', name: 'James Wilson', type: 'Annual', days: 5, range: 'May 20 - May 24', status: 'Pending', dept: 'ENG' },
  { id: 'LEV-015', name: 'Elena Vance', type: 'Sick', days: 2, range: 'May 15 - May 16', status: 'Pending', dept: 'FIN' },
];
    ...
    <div className="bg-white border border-[#E2E8F0] rounded-3xl p-8 shadow-sm h-full flex flex-col">
      <div className="flex items-center justify-between mb-8">
        <div>
           ...
           <p className="text-[10px] text-[#94A3B8] font-bold uppercase tracking-widest mt-1">Review & Process Workforce Requests</p>
        </div>
      ...
      <div className="flex-1 space-y-4 overflow-auto scrollbar-hide">
         {MOCK_REQUESTS.map((req) => (
           <div key={req.id} className="p-5 rounded-2xl border border-[#F1F5F9] bg-[#F8FAFC] hover:border-blue-200 transition-all group">
              <div className="flex items-start justify-between mb-4">
                 <div className="flex items-center gap-3">
                    ...
                    <div>
                       ...
                       <p className="text-[9px] font-bold text-[#94A3B8] uppercase">{req.dept} • {req.type} Leave</p>
                    </div>
                 </div>
              ...
              <div className="flex items-center justify-between py-4 border-y border-white">
                 <div>
                    <p className="text-[9px] font-black text-[#94A3B8] uppercase tracking-widest mb-0.5">Requested Duration</p>
                    <p className="text-xs font-bold text-[#0F172A]">{req.range}</p>
                 </div>
                 <div className="text-right">
                    <p className="text-[9px] font-black text-[#94A3B8] uppercase tracking-widest mb-0.5">Total Days</p>
