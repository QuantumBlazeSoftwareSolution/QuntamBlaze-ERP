      ...
      <div className="max-w-3xl mx-auto space-y-10">
        <div className="flex items-center justify-between">
           ...
           <div className="px-3 py-1.5 rounded-lg bg-accent/10 border border-accent/30 flex items-center gap-2">
             ...
             <span className="text-[11px] font-mono font-bold text-accent">{watch("invoiceId")}</span>
           </div>
        </div>

        {/* Project Selection */}
        <div className="space-y-4">
          <label className="text-[11px] font-bold text-text-muted uppercase tracking-widest">Project Selection</label>
        ...
        <div className="grid grid-cols-2 gap-6">
           <div className="space-y-2">
              <label className="text-[10px] font-bold text-text-muted uppercase tracking-widest">Client Name</label>
              <input 
                {...register("clientName")}
                readOnly
           ...
           <div className="space-y-2">
              <label className="text-[10px] font-bold text-text-muted uppercase tracking-widest">CLI-ID</label>
              <input 
                {...register("clientId")}
                readOnly
        ...
        <div className="space-y-6">
          <label className="text-[11px] font-bold text-text-muted uppercase tracking-widest">Line Items</label>
