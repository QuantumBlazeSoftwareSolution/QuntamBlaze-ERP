    ...
    <div className="w-[300px] bg-white border-l border-divider h-full overflow-y-auto p-8 space-y-10 shadow-sm">
      ...
      <div className="space-y-6">
        <div className="space-y-2">
           <p className="text-[10px] font-bold text-text-muted uppercase tracking-[0.2em]">Document Identity</p>
           <IDChip id={docId} className="bg-accent/10 border-accent/30 text-accent text-[13px] px-4 py-2 w-full justify-center" />
