    ...
    <div className="space-y-6 sticky top-24">
      ...
      <div className="bg-bg-card border border-border rounded-2xl p-6 shadow-2xl relative overflow-hidden group">
        ...
        <div className="flex items-center gap-2 mb-8 relative z-10">
          ...
          <h3 className="text-[11px] font-bold text-text-secondary uppercase tracking-[0.2em]">Client Intel</h3>
        </div>

        <div className="space-y-8 relative z-10">
          <div className="space-y-2">
            <p className="text-[10px] font-bold text-text-muted uppercase tracking-widest">Total Billed (YTD)</p>
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className={cn(
              ...
              <div className={cn("flex items-center gap-2 mb-2", hasOutstanding ? "text-danger" : "text-text-secondary")}>
                <Wallet className="w-3.5 h-3.5" />
                <span className="text-[10px] font-bold uppercase tracking-widest">Outstanding</span>
              </div>
              <div className="flex items-center gap-2">
                <p className={cn("text-2xl font-bold", hasOutstanding ? "text-danger" : "text-text-primary")}>
          ...
          {client.nextInvoiceDue && (
            <div className="pt-6 border-t border-border/50">
              <div className="flex items-center gap-2 text-accent mb-4">
                ...
                <span className="text-[10px] font-bold uppercase tracking-widest">Next Invoice Due</span>
              </div>
              <div className="space-y-1">
                <p className="text-[15px] font-bold text-text-primary">{client.nextInvoiceDue.date}</p>
