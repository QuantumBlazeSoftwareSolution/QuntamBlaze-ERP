    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between mb-8">
        <div className="flex items-center gap-3">
          ...
          <h2 className="text-[11px] font-bold text-text-secondary uppercase tracking-[0.2em]">Active Projects</h2>
        </div>
        <button className="text-[11px] font-bold text-accent uppercase tracking-widest hover:underline transition-all">View All</button>
      </div>
          ...
          >
            ...
            <div className="flex items-center gap-6">
              <div className="space-y-2">
                ...
                <h3 className="text-lg font-bold text-text-primary group-hover:text-accent transition-colors">{project.name}</h3>
              </div>
            </div>
            ...
            <div className="flex items-center gap-12">
               <div className="text-right space-y-2">
                  ...
                  <div className="flex items-center gap-3">
                    <span className="text-[14px] font-bold text-text-primary">{project.progress}%</span>
               ...
               {project.status === "Completed" ? (
                 <div className="text-right space-y-1 min-w-[120px]">
                    <p className="text-[10px] font-bold text-text-muted uppercase tracking-widest">Completed On</p>
