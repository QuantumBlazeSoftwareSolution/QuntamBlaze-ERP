    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
      ...
      <div className="bg-bg-card/30 border border-border rounded-2xl p-8 space-y-8">
        <div className="flex items-center gap-3 pb-6 border-b border-border/50">
          ...
          <h3 className="text-[11px] font-bold text-text-secondary uppercase tracking-[0.2em]">Primary Contact</h3>
        </div>

        <div className="space-y-6">
          <div className="space-y-1">
            <p className="text-2xl font-bold text-text-primary tracking-tight">{client.contactPerson}</p>
            <p className="text-[13px] text-accent font-medium uppercase tracking-widest opacity-80">Chief Executive Officer</p>
          </div>
      ...
      <div className="bg-bg-card/30 border border-border rounded-2xl p-8 space-y-8">
        <div className="flex items-center gap-3 pb-6 border-b border-border/50">
          ...
          <h3 className="text-[11px] font-bold text-text-secondary uppercase tracking-[0.2em]">Billing & Terms</h3>
        </div>

        <div className="space-y-8">
          <div className="space-y-3">
             <p className="text-[11px] font-bold text-text-muted uppercase tracking-widest">Billing Address</p>
             <p className="text-[14px] text-text-secondary leading-relaxed max-w-xs">{client.billingAddress}</p>
          </div>

          <div className="grid grid-cols-2 gap-4">
            <div className="p-4 rounded-xl bg-bg-primary border border-border">
              <p className="text-[10px] font-bold text-text-muted uppercase tracking-widest mb-1">Payment Terms</p>
              <p className="text-[15px] font-bold text-accent">{client.paymentTerms}</p>
            </div>
            <div className="p-4 rounded-xl bg-bg-primary border border-border">
              <p className="text-[10px] font-bold text-text-muted uppercase tracking-widest mb-1">Currency</p>
