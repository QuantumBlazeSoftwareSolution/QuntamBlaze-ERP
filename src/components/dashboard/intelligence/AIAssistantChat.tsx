...
const MOCK_CHAT: ChatMessage[] = [
  {
    id: "msg-1",
    sender: "ai",
    text: "Hello Commander. I am Quantum AI. I have analyzed the recent Q2 projections. Would you like a breakdown of the anomalies detected in the CRM pipeline?",
  },
];
