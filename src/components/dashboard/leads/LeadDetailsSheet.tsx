...
import {
  X, Building2, Mail, Phone, User, Globe,
  Zap, FileText, Archive, TrendingUp, Tag,
} from "lucide-react";
...
function ScoreBar({ score }: { score: number }) {
  ...
  return (
    <div className="flex items-center gap-2">
      ...
      <span className={`text-[11px] font-bold w-6 ${
          ...
          >
            ...
            <div className="px-6 pt-6 pb-4 border-b border-divider bg-page-bg shrink-0">
              ...
              <div className="flex items-start justify-between">
                ...
                <span className={cn("text-[11px] font-bold px-2.5 py-1 rounded-full border", statusConfig.color)}>
                  {statusConfig.label}
                </span>
              </div>
              ...
              {/* Score */}
              <div className="mt-4">
                <p className="text-[10px] font-bold text-text-muted uppercase tracking-widest mb-1.5">Lead Score</p>
            ...
            {!isLost && (
              <div className="px-6 py-4 border-b border-divider bg-white shrink-0">
                <p className="text-[10px] font-bold text-text-muted uppercase tracking-widest mb-3">Pipeline Stage</p>
                    ...
                    return (
                      <div key={stage} className="flex items-center flex-1">
                        ...
                        {i < PIPELINE_STAGES.length - 1 && (
                          <div className={cn("w-1.5 h-1.5 rounded-full mx-0.5 shrink-0",
            ...
            <div className="flex border-b border-divider bg-white shrink-0">
              {(["overview", "notes"] as const).map((t) => (
                ...
                >
                  {t}
                  {tab === t && (
                    <motion.div layoutId="lead-sheet-tab" className="absolute bottom-0 left-0 right-0 h-0.5 bg-accent" />
                  )}
                </button>
              ))}
            </div>
            ...
            <div className="flex-1 overflow-y-auto custom-scrollbar p-6 space-y-6">
              {tab === "overview" && (
                <>
                  ...
                  <div className="space-y-3">
                    <h3 className="text-[10px] font-bold text-text-muted uppercase tracking-widest">Contact Information</h3>
                  ...
                  {/* Deal Info */}
                  <div className="space-y-3">
                    <h3 className="text-[10px] font-bold text-text-muted uppercase tracking-widest">Deal Details</h3>
                    <div className="grid grid-cols-2 gap-3">
                      ...
                      <div className="p-4 bg-page-bg border border-divider rounded-xl">
                        ...
                        <p className="text-sm font-bold text-text-primary">{lead.lastContactedAt}</p>
                      </div>
                    </div>
                  </div>
                </>
              ...
              {tab === "notes" && (
                <div className="space-y-3">
                  <h3 className="text-[10px] font-bold text-text-muted uppercase tracking-widest">Internal Notes</h3>
                  <div className="p-4 bg-page-bg border border-divider rounded-xl">
