    ...
    <div className="bg-white border border-border rounded-2xl overflow-hidden shadow-sm">
      <div className="p-8 border-b border-divider bg-page-bg">
        ...
        <p className="text-[13px] text-text-muted mt-2">
          Manage the sequence counters and patterns for all system entities.
        </p>
      </div>
        ...
        <table className="w-full text-left border-collapse">
          <thead>
            <tr className="bg-page-bg border-b border-divider">
              <th className="px-8 py-5 text-[10px] font-bold text-text-muted uppercase tracking-widest">
                Entity Type
              </th>
              <th className="px-8 py-5 text-[10px] font-bold text-text-muted uppercase tracking-widest">
                ID Pattern
              ...
              <th className="px-8 py-5 text-[10px] font-bold text-text-muted uppercase tracking-widest text-right">
                Counter
              </th>
              <th className="px-8 py-5 text-[10px] font-bold text-text-muted uppercase tracking-widest text-right">
                Actions
