      ...
      >
        ...
        <div className="px-6 py-5 border-b border-[#F1F5F9] flex items-center justify-between">
          <div className="flex items-center gap-3">
            <IDChip
              id={selectedTaskId}
              variant="accent"
              className="bg-[#ECFDF5] border-[#A7F3D0] text-[#065F46]"
            />
        ...
        <div className="px-6 py-8">
          <div className="group relative">
            <h2
              className="text-2xl font-black text-[#0F172A] leading-tight outline-none focus:border-b-2 focus:border-[#10B981] pb-1 cursor-text"
              contentEditable
              spellCheck={false}
            >
            ...
            <div className="p-6 space-y-10">
              ...
              <div className="grid grid-cols-2 gap-x-8 gap-y-6">
                ...
                <MetaItem label="Designated Owner" icon={<User />}>
                  <div className="flex items-center gap-2">
                    <div className="w-6 h-6 rounded-full bg-emerald-500 flex items-center justify-center text-white text-[10px] font-black border-2 border-white shadow-sm">
                      JD
                    </div>
              ...
              <div className="space-y-4">
                ...
                <p className="text-sm text-[#475569] leading-relaxed">
                  ...
                  identifying latency bottlenecks in the API Gateway and potential security gaps in
                  the VPC peering layer. Deliverable: PDF Audit Report.
                </p>
              </div>
      ...
      <div
        className={cn(
          ...
          completed
            ...
            : "bg-white border-[#E2E8F0] hover:border-[#10B981]"
        )}
      >
        {completed && (
...
function ActivityItem({
  ...
  return (
    <div className="flex items-center gap-3">
      <div
        className={cn(
          "w-6 h-6 rounded-lg flex items-center justify-center text-white text-[9px] font-black",
          color
        )}
      >
        {user}
