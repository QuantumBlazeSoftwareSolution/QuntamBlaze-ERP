  ...
  return (
    <div
      ...
      className={cn(
        ...
        isOver &&
          "border-dashed border-2 border-[#10B981]/40 bg-[#ECFDF5]/30 ring-4 ring-[#10B981]/5"
      )}
    >
      {/* Header */}
      <div
        className={cn(
          ...
          column.accentColor.includes("emerald")
            ? "border-b-[#10B981]"
            : column.accentColor.includes("amber")
              ? "border-b-amber-500"
              : column.accentColor.includes("blue")
                ? "border-b-blue-500"
                : "border-b-slate-100"
        )}
      >
