...
const MOCK_TRANSACTIONS: Transaction[] = [
  {
    id: "INV-26-089",
    label: "Initial Milestone Payment",
    amount: 45000,
    date: "2026-02-15",
    status: "Paid",
    type: "Invoice",
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="flex items-center justify-between mb-8">
            <div>
              ...
              <p className="text-xs font-bold text-[#94A3B8] uppercase tracking-widest mt-1">
                Resource burn vs. timeline progress
              </p>
            </div>
          ...
          <div className="space-y-6">
            <div className="flex justify-between items-end">
              <div>
                ...
                <p className="text-4xl font-black text-[#0F172A] mt-1">
                  58.0<span className="text-xl">%</span>
                </p>
              </div>
            ...
            <div className="grid grid-cols-3 gap-4 pt-4 border-t border-[#F1F5F9]">
              <MiniMetric
                label="Resource Cost"
                value={formatCurrency(84000, true)}
                color="bg-[#3B82F6]"
              />
              <MiniMetric
                label="Infra Spend"
                value={formatCurrency(28000, true)}
                color="bg-[#8B5CF6]"
              />
              <MiniMetric
                label="Contingency"
                value={formatCurrency(12000, true)}
                color="bg-[#F59E0B]"
              />
            </div>
          </div>
        ...
        <div className="bg-[#111827] rounded-3xl p-8 text-white relative overflow-hidden shadow-2xl">
          ...
          <div className="relative z-10">
            <h4 className="text-[10px] font-black uppercase tracking-[0.2em] text-[#94A3B8] mb-6">
              Financial Status
            </h4>
            <div className="space-y-6">
...
function MiniMetric({ label, value, color }: { label: string; value: string; color: string }) {
  return (
    <div className="flex items-center gap-3">
      ...
      <div>
        <p className="text-[9px] font-black text-[#94A3B8] uppercase tracking-widest leading-none">
          {label}
        </p>
