  ...
  return (
    <div className="grid grid-cols-1 xl:grid-cols-3 gap-8">
        ...
        <div className="bg-white border border-[#E2E8F0] rounded-xl p-8 shadow-sm">
           ...
           <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
              <div>
                 ...
                 <div className="space-y-4">
                    <div className="flex items-center gap-3">
                       <div className="w-10 h-10 rounded-xl bg-[#F8FAFC] border border-[#F1F5F9] flex items-center justify-center text-[#475569] text-xs font-black">START</div>
                       <div>
                    ...
                    <div className="flex items-center gap-3">
                       <div className="w-10 h-10 rounded-xl bg-[#F8FAFC] border border-[#F1F5F9] flex items-center justify-center text-red-500 text-xs font-black">END</div>
                       <div>
              ...
              <div className="md:col-span-2">
                 ...
                 <div className="flex items-center gap-4">
                    ...
                    <span className="text-[10px] font-black text-[#94A3B8] uppercase tracking-widest">Active Collaboration</span>
                 </div>
              </div>
           </div>
           ...
           <div className="mt-10 pt-10 border-t border-[#F1F5F9]">
              <div className="flex items-center justify-between mb-2">
                 <p className="text-[10px] font-black text-[#94A3B8] uppercase tracking-widest">Budget Allocation [${(project.budget / 1000000).toFixed(1)}M]</p>
                 <span className="text-[10px] font-black text-[#10B981] uppercase tracking-widest">{Math.round((project.budgetSpent / project.budget) * 100)}% Spent</span>
              </div>
      ...
      <div className="space-y-8">
        <div className="bg-white border border-[#E2E8F0] rounded-xl p-8 shadow-sm">
           <h4 className="text-[10px] font-black text-[#0F172A] uppercase tracking-[0.2em] mb-8">Context Actions</h4>
           <div className="grid grid-cols-2 gap-4">
              <div className="p-4 rounded-xl bg-[#F8FAFC] border border-[#F1F5F9]">
                 <p className="text-[9px] font-black text-[#94A3B8] uppercase tracking-widest mb-1">Open Tasks</p>
              ...
              <div className="p-4 rounded-xl bg-[#FEF2F2] border border-[#FECACA] group cursor-pointer hover:bg-red-100 transition-all">
                 <p className="text-[9px] font-black text-[#EF4444] uppercase tracking-widest mb-1">Blockers</p>
       ...
       {milestones.map((ms, idx) => (
         <div key={ms.id} className="flex flex-col items-center text-center relative z-10 flex-1">
            <div className={cn(
              ...
              ms.state === 'completed' ? "bg-[#10B981] text-white shadow-lg shadow-[#10B981]/20" :
              ms.state === 'current' ? "bg-white border-4 border-[#10B981] animate-pulse" :
...
function LinkedDocumentsPanel({ documents }: { documents: LinkedDocument[] }) {
  return (
    <div className="bg-white border border-[#E2E8F0] rounded-xl p-8 shadow-sm">
       <h4 className="text-[10px] font-black text-[#0F172A] uppercase tracking-[0.2em] mb-8">Linked Documents</h4>
          ...
          {documents.map((doc) => (
            <IDChip 
              ...
              className={cn(
                ...
                doc.type === 'proposal' ? "bg-blue-50 border-blue-100 text-blue-700" :
                doc.type === 'agreement' ? "bg-emerald-50 border-emerald-100 text-emerald-700" :
