      ...
      <div className="p-8 max-w-[1600px] mx-auto w-full flex-1 flex flex-col">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-8">
          <div>
            ...
            <p className="text-[#475569] text-sm mt-1">Manage salary structures, statutory rules, and payroll processing.</p>
          </div>
...
function StatRow({ label, value, sub, trend }: { label: string, value: string, sub: string, trend?: string }) {
  return (
