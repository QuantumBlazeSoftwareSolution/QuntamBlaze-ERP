...
const statsData = [
  {
    ...
    trend: 0.01,
    isPositive: true,
    sparkline: [{ value: 99.9 }, { value: 99.95 }, { value: 99.98 }, { value: 99.99 }],
  },
  {
    label: "Server Load",
    value: "42%",
    trend: -5.2,
    isPositive: true,
    sparkline: [{ value: 65 }, { value: 50 }, { value: 45 }, { value: 42 }],
  },
  {
    ...
    trend: 50,
    isPositive: false,
    sparkline: [{ value: 0 }, { value: 1 }, { value: 2 }, { value: 2 }],
  },
  {
    ...
    trend: 12.5,
    isPositive: true,
    sparkline: [{ value: 10 }, { value: 12 }, { value: 13 }, { value: 14 }],
  },
];
      ...
      <div className="flex items-center justify-between shrink-0 mb-6">
        <motion.div variants={itemVariants}>
          ...
          <p className="text-text-secondary mt-1">
            Real-time system health and resource allocation.
          </p>
        </motion.div>
