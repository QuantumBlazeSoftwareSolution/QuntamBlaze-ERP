    ...
    <div className="space-y-12 pb-24">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
        ...
        >
          ...
          <p className="text-text-secondary text-lg">Global oversight and permission orchestration.</p>
        </motion.div>
      ...
      <section className="space-y-6">
        <div className="flex items-center gap-3 px-1">
           ...
           <h2 className="text-[11px] font-bold text-text-muted uppercase tracking-[0.2em]">Active Operatives</h2>
        </div>
        <motion.div
      ...
      <section className="space-y-6">
        <div className="flex items-center gap-3 px-1">
           ...
           <h2 className="text-[11px] font-bold text-text-muted uppercase tracking-[0.2em]">Permission Matrix</h2>
        </div>
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
