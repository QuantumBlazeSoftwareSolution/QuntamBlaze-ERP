import { pgTable, varchar, timestamp, text, integer, uuid, pgEnum, jsonb, boolean } from 'drizzle-orm/pg-core';
import { employees } from './employees';

export const onboardingStatusEnum = pgEnum('onboarding_status', [
  'pre_arrival', 'day_1', 'week_1', 'month_1', 'month_2', 'month_3', 'completed'
]);

export const taskCategoryEnum = pgEnum('onboarding_task_category', [
  'IT', 'HR', 'Finance', 'Team', 'Training', 'Operations'
]);
...
export const onboardingTasks = pgTable('onboarding_tasks', {
  ...
  planId: varchar('plan_id').references(() => onboardingPlans.id).notNull(),
