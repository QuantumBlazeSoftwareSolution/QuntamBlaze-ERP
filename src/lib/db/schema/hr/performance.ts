import { pgTable, varchar, timestamp, text, integer, uuid, pgEnum, boolean, numeric } from 'drizzle-orm/pg-core';
...
export const reviewCycleStatusEnum = pgEnum('review_cycle_status', [
  'Open', 'Self-Review', 'Manager-Review', 'Closed'
]);
...
export const keyResults = pgTable('key_results', {
  ...
  goalId: varchar('goal_id').references(() => performanceGoals.id).notNull(),
